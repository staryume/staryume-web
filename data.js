...
const siteData = {
    "posts": [
        ...
        },
        {
            ...
            "content": {
                "jp": "## C108 お品書き\n\nサークル15周年を記念して、今回のお品書きはいつもより少し豪華になっています！\n<br>\nさらに今回は、お品書き画像上の商品をタップ／クリックすると詳細を確認できるインタラクティブなお品書きに対応しました。\n<br>\n気になる商品を画像から直接チェックしていただけます。\n<br><br>\nコミックマーケット108でお待ちしております！\n<br>\n<strong>配置：</strong>1日目(土) 西 あ-69ab ／ 2日目(日) 東 ウ-11b\n<br>\n<strong>最終更新：</strong> 2026/08/13",
        ...
        },
        {
            ...
            "content": {
                "jp": null,
                "en": "## Fancy Frontier 47 Product Info\n\nFor Hoshiyumetei's 15th anniversary, this FF47 lineup is richer than usual!\n<br>\nThe product menu is interactive — tap or click items on the image for details.\n<br>\nTaiwan pre-orders: [store.html?region=TW](./store.html?region=TW) <span style='color:#8B0000'>(Pre-orders closed)</span>\n<br>\nSee you this weekend!\n<br>\n<strong>Booth:</strong><br>Day 1 (Fri 8/21) Expo Hall U-35 / U-36<br>Day 2 (Sat 8/22) EZspace Yuanshan Hall Zone J (hours 10:30-18:30)<br>Day 3 (Sun) 8/23 Expo Hall S-27 / S-28 ありぃずこーひー (consignment / pickup)\n<br>\n<strong>Last update:</strong> 2026/08/20",
                "zh": "## FF47 販售物情報\n\n因為今年是星夢亭的成立 15週年紀念，這次 FF47 的販售物會比以往的豐富!\n<br>\n同時這次價目表的顯示方式也超絕強化，變成一個可以 \"互動\" 的價目表、\n<br>\n只需要按下價目表內對應的商品位置、就可以看到詳細的介紹資訊!\n<br>\n台灣地區亦可先到網店預約： [前往網店預約](./store.html?region=TW) <span style='color:#8B0000'>(預約已結束)</span>\n<br>\n期待這個週末見面!\n<br>\n<strong>攤位：</strong><br>第一日（五）8/21 花博爭豔館 U-35 / U-36<br>第二日（六）8/22 EZspace圓山館 J區（營業時間 10:30-18:30）<br>第三日（日）8/23 花博爭豔館 S-27 / S-28 ありぃずこーひー (寄賣/取貨)\n<br>\n<strong>最終更新：</strong> 2026/08/20"
            },
            "langs": {
                "jp": false,
                "en": true,
    ...
    "gallery": [
        {
            "id": 1,
            "tag": "FANART",
            "src": "./assets/gallery/g20250705.jpg"
        },
        {
            "id": 2,
            "tag": "FANART",
            "src": "./assets/gallery/g20241212.jpg"
        },
        {
            "id": 3,
            "tag": "FANART",
            "src": "./assets/gallery/g20240611.jpg"
        },
        {
            "id": 4,
            "tag": "FANART",
            "src": "./assets/gallery/g20240219.jpg"
        },
        {
            "id": 5,
            "tag": "FANART",
            "src": "./assets/gallery/g20240119.jpg"
        },
        {
            "id": 6,
            "tag": "FANART",
            "src": "./assets/gallery/g20230323.jpg"
        },
        {
            "id": 7,
            "tag": "FANART",
            "src": "./assets/gallery/g20221212.jpg"
        },
        {
            "id": 8,
            "tag": "FANART",
            "src": "./assets/gallery/g20220623.jpg"
        },
        {
            "id": 9,
            "tag": "FANART",
            "src": "./assets/gallery/g20190708.jpg"
        }
    ],
    "translations": {
        "jp": {
            "hero_sub": "漫画家・イラストレーター",
            "status_text": "東京 - COMIC1☆28 申込完了",
            "profile_desc": "星遥ゆめ<br><br>漫画家・イラストレーター。<br>同人サークル「星夢亭」主催。"
        },
        "en": {
        ...
        "zh": {
            "hero_sub": "漫畫家 / 插畫家",
            "status_text": "東京 - COMIC1☆28 已報名",
            "profile_desc": "星遙<br><br>漫畫家・插畫家. <br>同人社團「星夢亭」的幕後打雜。"
        }
    }
};
