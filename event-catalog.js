        ...
        "afterShowcase": {
            "zh": [
                ...
                },
                {
                    ...
                    "body": "歡迎參加色紙競標！<br><br><strong>日時：</strong>第三日（日）8/23<br><strong>場所：</strong>花博爭豔館 S-27 / S-28 ありぃずこーひー<br><strong>競標開始價格:</strong> NT1000 ， 往後每一口價以 NT100 為單位<br><strong>色紙領取時間:</strong> 8/23（日）15:00<br><br>若中標者無法進入 FF 會場，可安排於花博入口交接色紙。<br><br>截標前 30 秒內如有新出價，截標時間自動延長 1 分鐘。<br><br>競標頁面： [前往色紙競標](./auction.html)<br><br>色紙將於特設的競標頁面決定最高競標金額得主。",
                    "images": [
                        {
                            "src": "./blog/20260818/shikishi-ff47.jpg?v=20260822",
                            "alt": "FF47 色紙競標（ブラマジガール）",
                            "caption": "",
                            "wide": true
                        }
                    ]
            ...
            "en": [
                ...
                },
                {
                    ...
                    "body": "Join the shikishi (signed art board) auction.<br><br><strong>When:</strong> Day 3 (Sun) 8/23<br><strong>Where:</strong> Expo Hall S-27 / S-28 ありぃずこーひー<br><strong>Starting bid:</strong> NT1000, each raise NT100<br><strong>Shikishi pickup:</strong> Sun 8/23 15:00<br><br>If the winner cannot enter the FF venue, handover can be arranged at the Huabo (Expo) entrance.<br><br>If a new bid arrives in the final 30 seconds, the close time is extended by 1 minute.<br><br>Auction page: [Bid on the shikishi](./auction.html)<br><br>The winner is the highest bidder on the dedicated auction page.",
                    "images": [
                        {
                            "src": "./blog/20260818/shikishi-ff47.jpg?v=20260822",
                            "alt": "FF47 shikishi auction (Dark Magician Girl)",
                            "caption": "",
                            "wide": true
                        }
                    ]
